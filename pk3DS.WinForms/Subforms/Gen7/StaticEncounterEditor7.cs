...
public partial class StaticEncounterEditor7 : Form
{
    ...
    private void AddTradeUtilityButtons()
    {
        ...
        B_TradeAnyRequest = new Button
        {
            ...
            Text = "Trades accept any Pokémon",
    ...
    private void B_TradeAnyRequest_Click(object sender, EventArgs e)
    {
        if (WinFormsUtil.Prompt(
            ...
            "Make all in-game trades accept any Pokémon?",
            "This sets Requested Species to (None) for every in-game trade. The NPC will still give the same Pokémon unless you also randomize the offered Pokémon.") != DialogResult.Yes)
        {
            return;
        }
        ...
        WinFormsUtil.Alert("Trades updated!", $"{Trades.Length} in-game trades now accept any Pokémon.");
    }
    ...
    private void B_TradeAcceptAnyRandomOffer_Click(object sender, EventArgs e)
    {
        if (WinFormsUtil.Prompt(
            ...
            "This will make every in-game trade accept any Pokémon and randomize the Pokémon the NPC gives you. This does not change the party-only selection UI.") != DialogResult.Yes)
        {
            return;
        }
        ...
        WinFormsUtil.Alert("Trades randomized!", $"{Trades.Length} in-game trades now accept any Pokémon and give randomized Pokémon.");
    }
